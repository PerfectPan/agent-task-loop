...
domains with six locally authenticated CLI seats: Claude Relay, Claude, Grok,
Codex, OpenCode, and DSH.
...
- **Room chat** broadcasts unmentioned messages to all six CLIs. `@agent`
...
- **Six-seat count-off** calls the roster in a fixed order. Every number is a
