...
export const TEST_AGENTS: readonly AgentDefinition[] = [
  { id: 'relay', label: 'Relay', role: '转述', command: 'relay --headless', color: 1, position: 0, systemPrompt: '' },
  { id: 'claude', label: 'Claude', role: '审核', command: 'claude -p', color: 2, position: 1, systemPrompt: '' },
  { id: 'codex', label: 'Codex', role: '实施', command: 'codex exec', color: 3, position: 2, systemPrompt: '' },
  { id: 'opencode', label: 'OpenCode', role: '搭建', command: 'opencode run', color: 4, position: 3, systemPrompt: '' },
