...
const distEntrypoint = path.join(packageRoot, 'dist', 'orch.js');
const sourceEntrypoint = path.join(packageRoot, 'src', 'infrastructure', 'cli.ts');
